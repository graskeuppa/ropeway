...
public class HashTable<K, V> {
    ...
    // Las cartas que entran a las cajas de correo llevan un nombre (key) y contenido (value)
    ...
    // Regla del edificio para determinar la caja de correos a usar en base al nombre
    ...
    // GET: Revisar en qué caja de correo está una carta en base al nombre del residente, leerla
    public V get(K key) {
    ...
    //REMOVE: Sacar el correo de la caja dado el nombre del residente. Lee la carta y la saca
